...
export class ProductControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAllProductsBySellerUsingGET(observe?: 'body', reportProgress?: boolean): Observable<Array<Product>>;
    public getAllProductsBySellerUsingGET(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Product>>>;
    public getAllProductsBySellerUsingGET(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Product>>>;
    public getAllProductsBySellerUsingGET(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Product>>(`${this.basePath}/productsBySeller`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public updateProductUsingPUT(product: Product, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<Product>(`${this.basePath}/products`,
            product,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
